...
export const CWebView: React.FC<ScreenProps<'CWebView'>> = ({route, navigation}) => {
            ...
            <View style={[styles.container, {paddingTop: insets.top}]}>
                <View style={styles.headerContainer}>
                    <TouchableOpacity
                        ...
                        onPress={goBack} style={styles.btnBack}>
                        <IconBack width={scale(25)} height={scale(25)}/>
                    </TouchableOpacity>
                    <View style={styles.headerRight}>
                        <Text
                            numberOfLines={1}
                            style={styles.headerTitle}>{loading ? 'Loading...' : title}</Text>
                    </View>
                </View>
                <ScrollView
